...
import com.intellect.book.dao.DictEmpOrgRelationMapper;
import com.intellect.book.dao.DictEmployeeMapper;
import com.intellect.book.dao.DictOrgAuthMapper;
import com.intellect.book.domain.entity.DictEmpOrgRelation;
...
public class DictOrgAuthServiceImpl extends AbstractBaseService<DictOrgAuth, DictOrgAuthMapper> implements DictOrgAuthService {
    ...
    @Autowired
    DictEmpOrgRelationMapper dictEmpOrgRelationMapper;

    @Override
    public List<String> getOrgIdByEmpId(String empId) {
    ...
    public void saveDoctorInfo(DoctorDTO doctorDTO, String orgId) {
        ...
        DictEmpOrgRelation dictEmpOrgRelation = new DictEmpOrgRelation();
        dictEmpOrgRelation.setEmpID(empId);
        dictEmpOrgRelation.setOrgID(orgId);
        dictEmpOrgRelationMapper.insert(dictEmpOrgRelation);
